...
/* harmony export */   availableServices: () => (/* binding */ availableServices),
...
const lastUpdated = _api_api_js__WEBPACK_IMPORTED_MODULE_0__.API.getLastUpdated();
...
const providers = _api_api_js__WEBPACK_IMPORTED_MODULE_0__.API.getAllProviders();
...
(0,_lib_simplemaps_utils_js__WEBPACK_IMPORTED_MODULE_2__.setMapCSURegions)();
(0,_lib_simplemaps_utils_js__WEBPACK_IMPORTED_MODULE_2__.setMapLocations)();

const lastUpdatedSpan = document.getElementById("lastUpdated");
lastUpdatedSpan.innerText = _api_js__WEBPACK_IMPORTED_MODULE_0__.lastUpdated;

const serviceSelect = document.getElementsByName("Service")[0];
_api_js__WEBPACK_IMPORTED_MODULE_0__.availableServices.forEach((service) => {
...
for (let i = 0; i < _api_js__WEBPACK_IMPORTED_MODULE_0__.availableLanguages.length; i++) {
  if (_api_js__WEBPACK_IMPORTED_MODULE_0__.availableLanguages[i] != "") {
    const option = document.createElement("option");
    option.value = _api_js__WEBPACK_IMPORTED_MODULE_0__.availableLanguages[i];
    option.text = _api_js__WEBPACK_IMPORTED_MODULE_0__.availableLanguages[i];
...
for (let i = 0; i < _lib_csu_js__WEBPACK_IMPORTED_MODULE_1__.CSUStructure.length; i++) {
  ...
  regionHeading.innerText = _lib_csu_js__WEBPACK_IMPORTED_MODULE_1__.CSUStructure[i].name;
  ...
  for (let j = 0; j < _lib_csu_js__WEBPACK_IMPORTED_MODULE_1__.CSUStructure[i].CSUs.length; j++) {
    ...
    csuLI.innerHTML = `<a href="pages/csu/index.html?id=${_lib_csu_js__WEBPACK_IMPORTED_MODULE_1__.CSUStructure[i].CSUs[j].slug}">${_lib_csu_js__WEBPACK_IMPORTED_MODULE_1__.CSUStructure[i].CSUs[j].name}</a>`;
...
_api_js__WEBPACK_IMPORTED_MODULE_0__.providers.forEach((provider) => {
...
_api_js__WEBPACK_IMPORTED_MODULE_0__.availableServices.forEach((service, index) => {
...
_api_js__WEBPACK_IMPORTED_MODULE_0__.availableLanguages.forEach((language, index) => {

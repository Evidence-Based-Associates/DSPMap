...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fipsID: () => (/* binding */ fipsID),
/* harmony export */   providerServices: () => (/* binding */ providerServices),
...
const providers = _api_api_js__WEBPACK_IMPORTED_MODULE_0__.API.getAllProvidersByFIPS(fipsID);
const providerServices = (providerId) => {
  return _api_api_js__WEBPACK_IMPORTED_MODULE_0__.API.getAllServicesByProviderInFIPS(providerId, fipsID);
};
...
(() => {
/*!*************************************!*\
  !*** ./src/pages/locality/index.js ***!
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api.js */ "./src/pages/locality/api.js");
...
localityText.innerText =
  // @ts-ignore
  simplemaps_statemap_mapdata.state_specific[_api_js__WEBPACK_IMPORTED_MODULE_0__.fipsID].name;

(0,_lib_simplemaps_utils_js__WEBPACK_IMPORTED_MODULE_1__.setMapLocations)();
(0,_lib_simplemaps_utils_js__WEBPACK_IMPORTED_MODULE_1__.zoomToFIPS)(_api_js__WEBPACK_IMPORTED_MODULE_0__.fipsID);
...
_api_js__WEBPACK_IMPORTED_MODULE_0__.providers.forEach((provider, key) => {
  ...
  const providerServiceList = (0,_api_js__WEBPACK_IMPORTED_MODULE_0__.providerServices)(key);

...
const regions = {
  0: {
    ...
    name: "Northern Region",
    color: _colors__WEBPACK_IMPORTED_MODULE_0__["default"].NorthernColor,
  },
  1: {
    states: localitiesFromRegion(CentralRegion),
    name: "Central Region",
    color: _colors__WEBPACK_IMPORTED_MODULE_0__["default"].CentralColor,
  },
  2: {
    states: localitiesFromRegion(WesternRegion),
    name: "Western Region",
    color: _colors__WEBPACK_IMPORTED_MODULE_0__["default"].WesternColor,
  },
  3: {
    states: localitiesFromRegion(SouthernRegion),
    name: "Southern Region",
    color: _colors__WEBPACK_IMPORTED_MODULE_0__["default"].SouthernColor,
  },
  4: {
    states: localitiesFromRegion(EasternRegion),
    name: "Eastern Region",
    color: _colors__WEBPACK_IMPORTED_MODULE_0__["default"].EasternColor,
  },
  5: {
    states: localitiesFromRegion(MidWestRegion),
    name: "Midwest Region",
    color: _colors__WEBPACK_IMPORTED_MODULE_0__["default"].MidWesternColor,
  },
};
